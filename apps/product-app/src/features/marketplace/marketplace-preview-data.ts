...
export const fallbackMarketplacePreviewSections: readonly MarketplacePreviewSection[] = [
  {
    ...
    readinessNote: 'Provider card detail now links into the live onboarding and profile workspace for providers.',
  ...
  },
  {
    ...
    description:
      'Providers can now complete profile updates, service-area setup, verification status checks, and rejection retries directly in product-app.',
    highlights: ['profile save workflow', 'verification status + retry', 'upload-url metadata handoff'],
    dataCoverageHint: 'Optional preview metadata is partially covered for this section.',
    dataCoverageBandToken: 'coverage-medium',
    sectionHealthLevel: 'watch',
    sectionSeverityBadgeToken: 'badge-watch',
    sectionAlignmentToken: 'align-mixed',
